Imports System.IO
Public Class Propriétairesvb
    
    Dim token As String
    Dim selectedRowIndex As Integer = -1

    Sub enregistrer()
        Dim fs As New FileStream("Propriétaire.txt", FileMode.Append, FileAccess.Write)
    ...
    Sub lister()
        Dim fs As New FileStream("Propriétaire.txt", FileMode.Open, FileAccess.Read)
    ...
    Private Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If selectedRowIndex >= 0 Then
            ...
            ' Lire toutes les lignes du fichier "Propriétaire.txt"
            Dim lines As New List(Of String)
            Using sr As New StreamReader("Propriétaire.txt")
            ...
            ' Écrire le contenu mis à jour dans "Propriétaire.txt"
            Using sw As New StreamWriter("Propriétaire.txt")
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        End While
        If Not found Then
            MessageBox.Show("Aucun résultat ne correspond à votre recherche !!! ", "ID_Prop")
